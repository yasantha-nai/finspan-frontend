...
const PHASES = [Phase1Identity, Phase2Income, Phase3Contributions, Phase4FutureReality, Phase5Strategy];
const STEP_LABELS = ['Identity & Timeline', 'Income & Assets', 'Contributions', 'Future Reality', 'Strategy'];
